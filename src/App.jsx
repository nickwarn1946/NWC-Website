  ...
  <div style={{ backgroundColor: '#2b3034', minHeight: '100vh', fontFamily: '"Roboto", sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center', color: '#ffffff', padding: '40px 20px' }}>
    ...
    <div style={{ background: 'linear-gradient(145deg, #1c3359, #162a4a)', padding: '60px 40px', borderRadius: '24px', boxShadow: '0 25px 60px rgba(0,0,0,0.5)', textAlign: 'center', maxWidth: '900px', width: '100%', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
      ...
      <div style={{ textAlign: 'left', lineHeight: '1.8', color: '#d1d9e0', marginBottom: '50px' }}>
        ...
        <p style={{ marginTop: '40px', fontSize: '1.2rem', textAlign: 'center', fontStyle: 'italic', color: '#ffffff', fontWeight: '300' }}>Not just a framework. A philosophy of leadership.</p>
      </div>
      <div style={{ marginTop: '20px' }}>
        <Link to="/payments" style={{ backgroundColor: '#3d4449', color: '#ffffff', padding: '18px 50px', borderRadius: '10px', textDecoration: 'none', fontSize: '1.1rem', fontWeight: '700', display: 'inline-block', boxShadow: '0 4px 20px rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)' }}>If you'd like to learn more, click here.</Link>
      </div>
    </div>
