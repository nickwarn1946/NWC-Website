...
// --- THE HOME PAGE (Nick Warn Consulting) ---
const Home = () => (
  <div style={{ 
      ...
      <div style={{ background: 'linear-gradient(145deg, #1c3359, #162a4a)', padding: '60px 40px', borderRadius: '24px', boxShadow: '0 25px 60px rgba(0,0,0,0.5)', textAlign: 'center', maxWidth: '1000px', width: '100%', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', marginBottom: '50px' }}>
          ...
          <div style={cardStyle}>
            ...
            {/* LIVE BOOKING LINK FOR INTRO SESSION */}
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '30px', color: '#aab7c4', fontSize: '0.85rem' }}>
          <p style={{ marginBottom: '10px' }}>All transactions are processed securely via Microsoft Bookings. Cancellations made more than 48 hours in advance are eligible for a full refund.</p>
          <p>© 2026 Nick Warn Consulting. All rights reserved.</p>
        </div>
